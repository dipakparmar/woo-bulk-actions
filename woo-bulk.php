<?php
/*
Plugin Name: Bulk Cancel Woo Orders
Plugin URI: 
Description: Plugin Add Cancel Bulk order option for Orders
Version: 1.0.0
Author: Dipak Parmar
Author URI: https://dipak.tech
License: Apache-3
License URI: 
*/
...
$bulk_actions['mark_change_status_to_cancelled'] = 'Cancel Order'; // <option value="mark_awaiting_shipment">Order Cancel</option>
return $bulk_actions;
